  ...
  protected function getTranslations() {
    return array(
      ...
      'These %d configuration value(s) are related:' => array(
        'Dieser Konfigurationswert ist dazugehörig:',
        'Diese Konfigurationswerte sind dazugehörig:',
      ),
     ...
     '%s edited question(s), added %s: %s; removed %s: %s.' =>
      ...
      '%s edited subscriber(s), added %d: %s; removed %d: %s.' =>
        '%s bearbeitete Abonennten, hinzugefügt: %3$s; entfernt: %5$s.',

      '%s added %d subscriber(s): %s.' => array(
        array(
          '%s fügte einen Abonennten hinzu: %3$s.',
          '%s fügte Abonennten hinzu: %3$s.',
        ),
      ),

      '%s removed %d subscriber(s): %s.' => array(
        array(
          '%s entfernte einen Abonennten: %3$s.',
          '%s entfernte Abonennten: %3$s.',
        ),
      ),
     ...
     #Overall ' => '',
      ...
      'Continue' => 'Fortfahren',
      'Set Sail for Adventure' => 'Segel setzen',
      'Send' => 'Senden',
      'Submit' => 'Senden',
      'Save' => 'Speichern',
     ...
     #Search
      ...
      'Open Documents' => 'Offene Dukumente',
     ...
     #Edit
      ...
      'To add files, drag and drop them into the comment text area.' =>
        'Um Dateien hochzuladen, benutze Drag and Drop und ziehe sie in das Textfeld.',
     ...
     #Projects
      'Project' => 'Projekt',
      'Projects' => 'Projekte',
      'Get Organized' => 'Werde Organisiert',
     ...
     #Settings
      'Server Default: %s' => 'Voreinstellung: %s',
